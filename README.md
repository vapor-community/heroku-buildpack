...
remote: -----> Using Swift 5.7.2 (default)
remote: -----> Using built-in clang (Swift 5.7.2)
remote: -----> Installing swiftenv
remote: -----> Installing Swift 5.7.2
...
```
...
The buildpack defaults to Swift 5.7.2 and will be updated when new Swift versions are released.

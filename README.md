...
remote: -----> Using Swift 5.9 (default)
remote: -----> Using built-in clang (Swift 5.9)
remote: -----> Installing swiftenv
remote: -----> Installing Swift 5.9
...
```
...
The buildpack defaults to Swift 5.9 and will be updated when new Swift versions are released.
...
$ git commit -m "Pin Swift version to 5.8.1"
...
```shell
$ heroku config:set SWIFT_VERSION=5.8.1
$ git commit -m "Pin Swift version to 5.8.1" --allow-empty
$ git push heroku main
```

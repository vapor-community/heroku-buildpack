...
remote: -----> Using Swift 5.7.3 (default)
remote: -----> Using built-in clang (Swift 5.7.3)
remote: -----> Installing swiftenv
remote: -----> Installing Swift 5.7.3
...
```
...
The buildpack defaults to Swift 5.7.3 and will be updated when new Swift versions are released.
